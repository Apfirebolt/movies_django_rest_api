"""
Django settings for django_movie_api project.
...
ALLOWED_HOSTS = ['206.81.29.244', 'localhost', 'http://softgenie.org']
...
WSGI_APPLICATION = 'django_movie_api.wsgi.application'
